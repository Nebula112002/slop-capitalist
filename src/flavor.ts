...
export const FLAVOR: FlavorLine[] = [
  ...
  { kind: "prestige", rarity: "common", text: "TikTok unlocked. Permanent +{gain}x" },
  { kind: "prestige", rarity: "uncommon", text: "Both farms reset. The multiplier stayed." },
  { kind: "prestige", rarity: "rare", text: "The algorithm remembers +{gain}x." },
