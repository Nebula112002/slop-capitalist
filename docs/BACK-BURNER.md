...
Ideas and bugs to do later. Not shipping from this file.

**Merge note:** another pass may add more sections here. Keep existing headings. Do not delete. The prestige write-up also lives in `docs/PRESTIGE-GATE.md` if this file is still filling in.
...
Canonical copy: `docs/PRESTIGE-GATE.md`.
